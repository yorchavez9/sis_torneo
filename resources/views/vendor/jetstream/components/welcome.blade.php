<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-6 text-gray-500">
        ¡Te damos la más cordial bienvenida a nuestro innovador sistema de torneos! Sumérgete en la emoción de la competencia, despliega tus habilidades y compite con los mejores. Explora nuevas dimensiones de diversión y supera desafíos. ¡Prepárate para una experiencia única llena de adrenalina y victorias inolvidables! 🏆🎮
    </div>
</div>
